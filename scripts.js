...
function getTeacherDetails(name) {
    const teachers = {
        'bcsc1012': 'Shubham Sharma (BCSC 1012) - Expert in Computer Science',
        'pcph0002': 'Lalit chauhan (PCPH 0002) - Physics Professor',
        'bcse0133': 'Priyanka Bera (BCSE 0133) - Software Engineering Specialist',
        'pgdh0001': 'Shyam Kuntail (PGDH 0001) - Data Science and Analytics',
        'pqrh0002': 'Nishu Agrawal (PQRH 0002) - Robotics Instructor',
        'pvrh0001': 'Sharad Dixit (PVRH 0001) - AI and Machine Learning Specialist',
